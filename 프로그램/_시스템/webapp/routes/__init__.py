...
def register_routes(app: Flask) -> None:
    ...
    from webapp.routes.optgen_sku import bp as optgen_sku_bp  # 미구성 SKU 편입 — 낱개 SKU 를 매트릭스 자리로
    ...
    app.register_blueprint(optgen_sku_bp)  # 미구성 SKU 편입 — 낱개 SKU 를 매트릭스 자리로
