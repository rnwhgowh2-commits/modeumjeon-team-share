...
const MOUM_EXT_VERSION = "0.7.38";   // 0.7.26 = [E2] 마진계산기 소싱처 주문상태 확인 배선 반영. 0.7.13 = 무신사 상품쿠폰 전량 수집(product_coupon_list). 0.7.12 = 롯데온 재고소스=base 엔드포인트 우선(완전 97셀). data-moum-ext 로 로드버전 확인 가능
