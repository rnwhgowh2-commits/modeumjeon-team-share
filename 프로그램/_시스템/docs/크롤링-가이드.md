...
| **롯데아이몰** | 내장 JSON+DOM | `itemInvQtyInfo[].inv_qty`(0=품절/실수량N/**30상한=충분→50 표기** `_lotteimall_disp_qty`) · WAF 403→curl_cffi 위장 | `last_stock` | `crawlers/lotteon.py`(도메인 라우팅) |
