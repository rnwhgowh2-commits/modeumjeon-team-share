...
# 🔴 '마진율'은 제외한다 — 사장님 확정(2026-07-25)으로 **의도적으로 옛 앱과 다르게** 만든다:
#   옛 앱 마진율 = 순마진/판매가(정가), 신 = 순마진/(실결제+배송비, 고객 결제금액).
#   순마진(=정산−매입)은 그대로라 여전히 비교한다 — 매출 기준이 달라도 손익 금액은 같다.
#   포팅 동치 규칙("어긋나면 신이 틀림")의 예외이므로 여기 근거를 남긴다.
MATCHED_FIELDS = [
    "마켓주문번호", "마켓", "상품명", "브랜드", "옵션_매출", "옵션_매입",
    "단가", "판매가", "실결제금액", "정산예상금액", "구매가격", "순마진",
    "수수료율", "수량_매출", "상품코드", "매칭타입", "일자", "월",
