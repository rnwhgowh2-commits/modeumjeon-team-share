...
const ROWS=[
 {'판매처_주문상태':'배송완료','국내송장번호':'123'},
 {'판매처_주문상태':'구매확정','국내송장번호':''},
 {'판매처_주문상태':'수취완료','국내송장번호':'9'},
 {'판매처_주문상태':'구매결정','국내송장번호':''},
 {'판매처_주문상태':'수취확인후주문취소','국내송장번호':'5'},   /* 취소 → 배송완료 아님 */
 {'판매처_주문상태':'배송중','국내송장번호':'777'},             /* 송장 있음 */
 {'판매처_주문상태':'배송중','국내송장번호':''},                /* 미입력 */
 {'판매처_주문상태':'','국내송장번호':'nan'},                   /* nan = 없음 */
];
