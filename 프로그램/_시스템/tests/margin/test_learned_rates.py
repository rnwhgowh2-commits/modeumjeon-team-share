# -*- coding: utf-8 -*-
"""마켓이 한 번 알려준 값을 기억해 재사용하는 경로 — 2026-07-25 정답지 전수 대조 회귀.

발견 경위: 정답지 정산예상금액과 237개 주문을 대조해 41건이 어긋났고, 그중
...
def test_실요율을_알면_고정값_대신_그걸_쓴다():
    """정답지 실측 주문 14101725882457: 실결제 50,400 · 실요율 11.88%.

    고정 11.55% → 44,579 (정답지보다 167원 많음). 실요율 → 44,412 (일치).
    """
