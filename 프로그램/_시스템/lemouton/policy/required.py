...
WIRING: dict[str, tuple[str, str]] = {
    ...
    # [2026-08-13 2단계] 여섯 칸 중 미성년자 구매 하나만 이어졌다.
    #   🔴 「이어졌다」로 뭉뚱그리면 나머지 다섯이 안 나가는 걸 아무도 모른다 —
    #     정확히 무엇이 나가고 무엇이 안 나가는지 적는다.
    'listing': (STORED_ONLY, '「미성년자 구매」만 마켓으로 나갑니다(쿠팡 adultOnly · '
                             '스스 minorPurchasable). 과세구분·상품상태·판매기간·'
                             '제조사는 아직 상품에 담을 칸이 없어 저장만 됩니다 — '
                             '정책에서 바꾸면 화면이 「못 보냈습니다」라고 말합니다.'),
}
