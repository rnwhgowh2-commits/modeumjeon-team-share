...
| 6 | 매트릭스(/matrix — **D-1 ✅** 폰 신축 /mobile/matrix, 아래 §6 D 참조)·마진(margin_embed — **E-1 ✅** 폰 신축 /mobile/settle, 아래 §6 E 참조)·크롤가이드 지도(map — **F-2 ✅** 폰 신축 /mobile/guide, 아래 §6 F 참조)·재고 items(시안 확정 대상 아님 — 미착수) | 괴물 | 별도 설계 |
